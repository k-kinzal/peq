...
#[Medium]
final class InstanceofProcessorTest extends TestCase
{
    public function testProcessRecordsTheClassAnInstanceofTestNames(): void
    {
        ...
        self::assertContains('Tests\Fixture\Source\GuardedClass::guarded -[instanceof]-> Tests\Fixture\Source\GuardedClass', $relations);
    }
    ...
    public function testProcessRecordsNothingForSourcesWithNoSuchRelation(): void
    {
        ...
        self::assertNotContains('Tests\Fixture\Source\GuardedClass::guarded -[instanceof]-> Tests\Fixture\Source\GuardedClass', $relations);
    }
}
