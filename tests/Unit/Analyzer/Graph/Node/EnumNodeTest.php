...
final class EnumNodeTest extends TestCase
{
    ...
    public function testDeclarationReturnsWhatTheSourceDeclaresAboutTheSymbol(): void
    {
        ...
        self::assertSame($declared, (new EnumNode(new EnumNodeId('App\Domain', 'InvoiceState'), true, null, $declared))->declaration());
    }

    public function testDeclarationIsNullForASymbolAnalysisOnlyReferredTo(): void
    {
        self::assertNull((new EnumNode(new EnumNodeId('App\Domain', 'InvoiceState')))->declaration());
    }
}
