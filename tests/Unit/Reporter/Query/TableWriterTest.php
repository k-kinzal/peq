...
final class TableWriterTest extends TestCase
{
     ...
     * @throws GqlException
     */
    public function testReportWritesTheAnswerAsATable(): void
    {
        $output = new BufferedOutput();
        (new TableWriter())->report(AnsweredQuery::table('MATCH (p:Class) RETURN p.name AS name ORDER BY name'), $output);
