...
final class DotWriterTest extends TestCase
{
     ...
     * @throws GqlException
     */
    public function testReportWritesThePieceOfGraphTheAnswerHoldsAsADigraph(): void
    {
        $output = new BufferedOutput();
        $answered = AnsweredQuery::table("MATCH (c:Class WHERE c.name = 'Store')-[:declaresMethod]->(m) RETURN c, m");
        (new DotWriter(SampleGraph::elements()))->report($answered, $output);
    ...
    public function testVertexWritesASymbolAsABoxLabelledWithItsNameAndWhatItIs(): void
    {
        self::assertSame(
