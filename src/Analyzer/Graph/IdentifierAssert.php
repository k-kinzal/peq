...
trait IdentifierAssert
{
     ...
     */
    protected static function assertIdentifier(string $value, null|string|\Throwable $description = null): void
    {
        assert(
     ...
     * @param null|string|\Throwable $description Optional description for assertion failure messages
     */
    protected static function assertNamespace(string $value, null|string|\Throwable $description = null): void
    {
        assert(
            $value !== '' && preg_match('/^[a-zA-Z_\x80-\xff][a-zA-Z0-9_\\\\\x80-\xff]*$/', $value) === 1,
            $description
